...
public class Parser {
    ...
    private File inFile; //The File we will parse
    private String outFile; //The File we will write to.
    ...
    public Parser(File file, String outFile) throws IOException {
        ...
        this.inFile = file;
        this.initWriter();
        //Moving parse() out of constructor and placing writer.close in parse()
        //this.parse();
        //this.writer.close();
    }
     ...
     * @throws IOException - Input or Output issues? I'll let you know!
     */
    public Parser() throws IOException {
        this.outFile = "Test.txt";
        this.inFile = new File("src\\CScrape.java"); //The inFile we will parse
        this.initWriter();
    }
    ...
    public void parse() throws IOException {
        ...
        this.writer.println("Comment Scraper - J. Morris");
